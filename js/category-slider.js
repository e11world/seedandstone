$(document).ready(function() {
    ...
    $(".category-item").mouseenter(function() {
			// $(this).animate({
			// 	opacity: "1"
			// }, 350).css("background-color", "transparent");
		...
		/* the viewport is more than 800 pixels wide */
		// $('.slider').slick();
		...
		*/
		...
		$(".category-item").mouseenter(function() {
			...
			$(this).find(".category-title-icon").animate({
				opacity: "1"
			}, 350).css("background-color", "#FF7F30").css("zIndex", "60");
			$(this).find(".category-title-icon > .category-img")
				// .siblings()
				.animate({
					opacity: "1"
				}, 100).css("display", "inline-block");
